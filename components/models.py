...
class Generator(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=3, im_size=1024):
        ...
        # Red de mapeo desde espacio latente a espacio mayor
        self.mapping_network = nn.Sequential(
            nn.Linear(nz, 256),
            nn.ReLU(),
            nn.Linear(256, nfc[4] * 4 * 4),  # Ajusta el tamaño para que coincida con el inicio
            nn.ReLU()
        )
    ...
    def forward(self, input):
        ...
        # Mapeo desde espacio latente a espacio mayor
        mapped_input = self.mapping_network(input)
        mapped_input = mapped_input.view(input.size(0), -1, 4, 4)  # Ajusta el tamaño
       ...
       # feat_satten = self.satten(feat_catten) * feat_catten
        ...
        #NUEVO
        feat_64  = self.se_64(mapped_input, self.feat_64(feat_32))
